...
import { PortableBody, headingsFromBody, headingsFromHtml, ensureH2Ids, cleanSyncedHtml, renderMaximusViews, stripInlineStyles, normalizeTables } from '@/components/PortableBody'
      ...
      <div className="wrap">
        <div className="article-wrap">
          ...
          <article className="prose">
            ...
            {data.bodyHtml
              ? <div dangerouslySetInnerHTML={{ __html: ensureH2Ids(renderMaximusViews(normalizeTables(stripInlineStyles(data.bodyHtml)))) }} />
